...
def get_flashattention_autograd_function_pytorch() -> Type:
    ...
    from cs336_systems.attention.flash_attention import FlashAttentionInPyTorch
    return FlashAttentionInPyTorch
...
def get_flashattention_autograd_function_triton() -> Type:
    ...
    from cs336_systems.attention.flash_attention import FlashAttentionInTriton
    return FlashAttentionInTriton
...
def get_ddp_individual_parameters(module: torch.nn.Module) -> torch.nn.Module:
    ...
    from cs336_systems.advanced_ddp.ddp import DDP
    return DDP(module)
...
def get_ddp_bucketed(module: torch.nn.Module, bucket_size_mb: float) -> torch.nn.Module:
    ...
    Returns:
        Instance of a DDP class.
    """
    from cs336_systems.advanced_ddp.ddp import DDPWithBucket
    return DDPWithBucket(module, bucket_size_mb)
